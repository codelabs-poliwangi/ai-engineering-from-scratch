...
(function () {
  ...
  var UI_TEXT = {
    en: {
      ...
      'adminAuth.kicker': 'Admin access',
      'adminAuth.title': 'Sign in to the control desk.',
      'adminAuth.subtitle': 'Use an owner or admin email to monitor registered learners, roles, and synced learning progress.',
      'adminAuth.note': 'Learner registration happens from the regular login page. Admin access is assigned by role.',
    ...
    id: {
      ...
      'adminAuth.kicker': 'Akses admin',
      'adminAuth.title': 'Masuk ke control desk.',
      'adminAuth.subtitle': 'Gunakan email owner atau admin untuk memantau learner, role, dan progress belajar yang tersinkron.',
      'adminAuth.note': 'Registrasi learner dilakukan dari halaman login biasa. Akses admin diberikan lewat role.',
