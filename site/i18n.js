...
(function () {
  ...
  var UI_TEXT = {
    en: {
      ...
      'home.attribution': 'Maintenance by community. Run on your own machine.',
      ...
      'home.how.p3': 'Each lesson runs the same loop: read the problem, derive the math, write the code, run the test, keep the artifact. No five-minute videos, no copy-paste deploys, no hand-holding. Free, open source, and built to run on your own laptop.',
      ...
      'home.colophon.body': 'Open source. No paywall, no signup, no account. Every lesson has runnable code in Python, TypeScript, Rust, or Julia. Clone the repo and serve locally in one command.',
      'home.footer': '© 2026 · open source · free forever',
      'site.footer': 'AI Engineering from Scratch · open source · free forever.',
    ...
    id: {
      ...
      'home.attribution': 'Dikelola oleh komunitas. Jalankan di laptop sendiri.',
      ...
      'home.how.p3': 'Setiap lesson memakai loop yang sama: baca problem, turunkan math, tulis code, jalankan test, simpan artifact. Tidak ada video lima menit, tidak ada copy-paste deploy, tidak ada jalan pintas yang membuat konsep hilang. Free, open source, dan dibuat agar bisa berjalan di laptop sendiri.',
      ...
      'home.colophon.title': 'Run Locally',
      'home.colophon.body': 'Seluruh kurikulum tersedia di GitHub. Clone, fork, dan belajar sesuai ritmemu. Tidak ada paywall, tidak ada signup. Setiap lesson punya runnable code dalam Python, TypeScript, Rust, atau Julia, tergantung konsepnya.',
      'home.footer': '© 2026 · open source · gratis selamanya',
      'site.footer': 'AI Engineering from Scratch · open source · gratis selamanya.',
